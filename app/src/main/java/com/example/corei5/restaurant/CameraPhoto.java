...
import com.example.corei5.restaurant.utils.BitmapStruct;
...
public class CameraPhoto extends AppCompatActivity {
    ...
    private boolean reviewPermissions() {
        ...
        if (this.checkSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
            return true;
        }
    ...
    private BitmapStruct saveToInternalStorage(Bitmap bitmapImage){
        ...
        // patch to /data/yourapp/app_data/imageDir
